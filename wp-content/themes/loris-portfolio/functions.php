...
/**
 * ------------------------------------------------------------
 * 6. Injection script Light/Dark (anti-flash, dans le <head>)
 * ------------------------------------------------------------
 */

function loris_theme_init_color_scheme()
{
...
add_action('wp_enqueue_scripts', 'loris_theme_init_color_scheme', 0);

/**
 * ------------------------------------------------------------
 * 7. Chargement des scripts JS (interaction)
 * ------------------------------------------------------------
 */
function loris_enqueue_scripts()
{
